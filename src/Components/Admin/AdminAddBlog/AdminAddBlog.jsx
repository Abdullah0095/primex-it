    ...
    return (
            ...
            <div className="max-w-md text-white">
                ...
                <form onSubmit={handlePostBlog}>
                    ...
                    <input className='m-2 h-16 w-96 bg-white rounded-md text-black text-xl font-bold' type="text" name="title" id="" /> <br />
                    <label className='m-2 font-bold' htmlFor="">Blog Detail</label>
                    <textarea className='m-2 h-16 w-96 bg-white rounded-md text-black text-xl font-bold' type="text" name="description" id="" /> <br />
                    <label className='m-2 font-bold' htmlFor="">Blog Link</label>
                    <textarea className='m-2 h-16 w-96 bg-white rounded-md text-black text-xl font-bold' type="text" name="link" id="" /> <br />
